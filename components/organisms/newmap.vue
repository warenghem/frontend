<template>
  <div class="h-100">
    <div style="height: 500px; width: 100%" class="pa-0">
      ...
      >
        <l-tile-layer
          :url="url"
        />
        <l-marker :lat-lng="[marker.location.latitude, marker.location.longitude]"
    ...
    <SideModalMap :is-modal="sideModal" v-on:closeModal="closeSideModal" :current="currentSideItem"
                    :product="product" />
